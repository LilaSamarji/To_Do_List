window.addEventListener('load',() => {
    ...
    form.addEventListener('submit',(e)=> {
        ...
        task_actions=document.createElement('div');
        task_actions.classList.add("actions")

        //CREATING EDIT IN ACTIONS
        task_edit=document.createElement('button');
        task_edit.classList.add("edit");
        task_edit.innerHTML="Edit";

        //CREATING DELETE IN ACTIONS
        task_delete=document.createElement('button');
        ...
        task_edit.addEventListener('click', () => {
            ...
            else {  task_input.setAttribute("readonly","readonly");
